        ...
        public void run() {
            ...
            if (isRun == 2) {
                ...
                if (hp == 0 && is_finish == false) {
                    animatorSet[2].pause();
                    Intent activity_change= new Intent(LevelFive.this, SuccessActivity.class);    //切换 Activity
                    Bundle bundle = new Bundle();// 创建Bundle对象
                    bundle.putInt("data",5 );//  放入data值为int型
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CCGLSurfaceView ccglSurfaceView=new CCGLSurfaceView(LevelFive.this);
                ...
                //将Layer层加到场景中
                try {
                    ccScene.addChild(new MenuLayer(username,LevelFive.this));
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent activity_change = new Intent(LevelFive.this, LevelFive.class);    //切换 Activityanother至MainActivity
                Bundle bundle = new Bundle();// 创建Bundle对象
                bundle.putString("username",username);
